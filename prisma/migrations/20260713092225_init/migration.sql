...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_variantLabel_key" ON "ProductVariant"("productId", "variantLabel");
...
-- CreateIndex
CREATE INDEX "OrderItemVariant_productVariantId_idx" ON "OrderItemVariant"("productVariantId");
...
-- AddForeignKey
ALTER TABLE "OrderItemVariant" ADD CONSTRAINT "OrderItemVariant_productVariantId_fkey" FOREIGN KEY ("productVariantId") REFERENCES "ProductVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
